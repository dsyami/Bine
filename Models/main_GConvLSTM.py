...
from Models.utils.GCN_dataloader import myDataLoaderGConvLSTM
from Network import GConvLSTM, GConvGRU, EEGGCNet
from Models.utils.GCN_dataloader import myDataLoaderATCNN
...
if __name__ == "__main__":
    ...
    parser.add_argument('--adj_mat_dir', default='/home/zhouzhiheng/STGCN/Models/dataset/EEG-Motor-Movement-Imagery-Dataset/mat_data/outputdata_20-subjects/Adjacency_Matrix.npy', help='Pearson matrix adj mat')   
    parser.add_argument('--adj_name', choices=('pearson', 'distance'), default='pearson')
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    parser.add_argument('--device', default=device)
    args = parser.parse_args()

    time_resolved_DIR = f'/home/zhouzhiheng/STGCN/Models/dataset/EEG-Motor-Movement-Imagery-Dataset/mat_data/outputdata_{args.subjects}-subjects/'
    adj = np.load(time_resolved_DIR + 'Adjacency_Matrix.npy')
    DIR = f'/home/zhouzhiheng/STGCN/Models/dataset/EEG-Motor-Movement-Imagery-Dataset/mat_data/outputdata_{args.subjects}-subjects/time_window/'
