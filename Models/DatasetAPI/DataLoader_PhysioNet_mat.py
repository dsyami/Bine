...
from constants import EEG_CHANNELS, FREQUENCY
...
def readalldata_from_mat(dir_path, out_dir, subjects, electrodes, train_rate, trials=84, sfreq=160, time=4):
...
def readdata_from_mat(dir_path, out_dir, subjects, electrodes, train_rate, trials=84, sfreq=160, time=4):
    label_path = dir_path + 'Labels_1.mat'
    label = loadmat(label_path)['Labels']       # [subjects, trials, 4]
...
subjects = 108
train_rate = 0.9
dir_path = f'../dataset/EEG-Motor-Movement-Imagery-Dataset/mat_data/{subjects}-Subjects/'
out_dir = f'../dataset/EEG-Motor-Movement-Imagery-Dataset/mat_data/outputdata_{subjects}-subjects/'
out_dir_time_window = f'../dataset/EEG-Motor-Movement-Imagery-Dataset/mat_data/outputdata_{subjects}-subjects/time_window/'
np.random.seed(421)
## 提取 time_resolved 数据
# readalldata_from_mat(dir_path, out_dir, subjects, electrodes, train_rate=train_rate)
## 提取 time_window 数据
