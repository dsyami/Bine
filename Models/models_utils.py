...
def computeCoarseningGraph(adj, data, levels, self_connections=False):
    adj = sp.csr_matrix(adj)
    adj_list, perm = coarsening.coarsen(adj, levels=levels, self_connections=self_connections)
    data = perm_data(data, indices=perm)
